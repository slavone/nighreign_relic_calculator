window.__LOCALE_KR__ = {
  "ui": {
    ...
    "meth_formula_p2": "풀이 <em>m</em>개 그룹(m ≥ K)에 걸쳐 있을 때 확률은:",
    "meth_formula_p3": "합계는 풀에서 K개 그룹을 선택하는 C(m,K)가지 방법 전체에 걸칩니다. 각 K개 그룹 부분집합 S에 대해 <code>ef(S, W)</code>는 그룹 제외를 고려합니다. ef 공식은 K! 가지 순서 전체를 평균합니다:",
    "meth_formula_p4": "그룹 내 모든 효과를 선택하면 해당 그룹의 기여 가중치가 최대화됩니다. 특정 유물 색상이 필요한 경우 최종 결과에 0.25를 곱하세요.",
